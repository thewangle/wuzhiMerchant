      ...
      <div class="wrap1 animated bounceInDown">
        <div class="wrap2">
          <div class="wrap3">
            <div class="wrap4"> 
              <span class="img1">
                <img class="orbit orbit-frame" src="../assets/img/card18.jpg" alt="card08" />
              </span>
              ...
              <div class="wrap5">
                <div class="nav-holder">
                  <!-- start menu !-->
                  <ul class="menuBuild">
                    <li id="menu1"><span @click="selectlm(1)">商品</span>
                      <ul class="submenu sub1">
                        <li class="first"><div @click="routes(6)">商品分类</div></li>
                        <li class="second"><div @click="routes(0)">添加商品</div></li>
                        <li class="second"><div @click="routes(1)">商品列表</div></li>
                        <li class=""><div @click="routes(7)">商品出库</div></li>
                        <li class="third"><div @click="routes(8)">商品入库</div></li>
                        <li class="last"><div @click="routes(9)">价格更改</div></li>
                      </ul>
                    </li>
                    <li id="menu2"><span @click="selectlm(2)">供应商</span>
                      <ul class="submenu sub2">
                        <li class="first"><div @click="routes(2)">添加供应商</div></li>
                        <li class="second"><div @click="routes(3)">供应商列表</div></li>
                      </ul>
                    </li>
                    <li id="menu3"><span @click="selectlm(3)">会员</span>
                      <ul class="submenu sub3">
                        <li class="first"><div @click="routes(4)">添加会员</div></li>
                        <li class="second"><div @click="routes(5)">会员列表</div></li>
                      </ul>
                    </li>
                  </ul>
              <!-- end menu !-->
...
export default {
  ...
  methods: {
    routes(num) {
      this.$router.push(this.urls[num])
    },
    selectlm(num) {
      if (num == 1) {
        $('.sub1').show()
...
/**************************************************************
If you choose to use the Franklin Gothic font then this code will help get you started with embedding it.
**************************************************************/
/**/
...
ul.menuBuild ul.submenu li{
  ...
  background: url(../assets/img/card08.png) no-repeat, linear-gradient(left, #565656 0%, #666 3%, #FFF 14%); /*future CSS3 browsers*/
    -pie-background: url(../assets/img/card08.png) no-repeat, linear-gradient(left, #565656 0%, #666 3%, #FFF 14%); /*PIE*/
...
ul.menuBuild ul.submenu li div{ 
  color:black;  /* the color of submenu fonts */
  /*opacity:0.65;*/  /* This blends the font in with the background */
  filter:alpha(opacity=65);
  font-size: 12px; /*no*/
  }
  
ul.menuBuild ul.submenu li div:hover{
  opacity:1.0;   /* and this brings the font opacity back to 100% */
  filter:alpha(opacity=100)
  }
  
ul.menuBuild li span {  /* for the main menu links */
  color: #fff; 
  display: block; 
  width: 100%; 
  }
  
ul.menuBuild li:hover > span { 
  color: #fff; 
